...
template void igl::combine<Eigen::Ref<Eigen::Matrix<double, -1, -1, 0, -1, -1> const, 0, Eigen::OuterStride<-1> > const, Eigen::Ref<Eigen::Matrix<int, -1, -1, 0, -1, -1> const, 0, Eigen::OuterStride<-1> > const, Eigen::Matrix<double, -1, -1, 0, -1, -1>, Eigen::Matrix<int, -1, -1, 0, -1, -1> >(std::vector<Eigen::Ref<Eigen::Matrix<double, -1, -1, 0, -1, -1> const, 0, Eigen::OuterStride<-1> > const, std::allocator<Eigen::Ref<Eigen::Matrix<double, -1, -1, 0, -1, -1> const, 0, Eigen::OuterStride<-1> > const> > const&, std::vector<Eigen::Ref<Eigen::Matrix<int, -1, -1, 0, -1, -1> const, 0, Eigen::OuterStride<-1> > const, std::allocator<Eigen::Ref<Eigen::Matrix<int, -1, -1, 0, -1, -1> const, 0, Eigen::OuterStride<-1> > const> > const&, Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1> >&, Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1> >&);
#ifdef WIN32
