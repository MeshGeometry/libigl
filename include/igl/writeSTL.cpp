...
// template bool igl::writeSTL<Eigen::Matrix<float, -1, -1, 0, -1, -1>, Eigen::Matrix<int, -1, -1, 0, -1, -1> >(std::basic_string<char, std::char_traits<char>, std::allocator<char> > const&, Eigen::PlainObjectBase<Eigen::Matrix<float, -1, -1, 0, -1, -1> > const&, Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1> > const&, bool);
...
#ifdef WIN32
template bool __cdecl igl::writeSTL<class Eigen::Matrix<double,8,3,0,8,3>,class Eigen::Matrix<int,12,3,0,12,3> >(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > const &,class Eigen::MatrixBase<class Eigen::Matrix<double,8,3,0,8,3> > const &,class Eigen::MatrixBase<class Eigen::Matrix<int,12,3,0,12,3> > const &,bool);
template bool __cdecl igl::writeSTL<class Eigen::Matrix<double,-1,3,0,-1,3>,class Eigen::Matrix<int,-1,3,0,-1,3> >(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > const &,class Eigen::MatrixBase<class Eigen::Matrix<double,-1,3,0,-1,3> > const &,class Eigen::MatrixBase<class Eigen::Matrix<int,-1,3,0,-1,3> > const &,bool);
#endif // WIN32
#endif
